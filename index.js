...
// //ok
// // app.get('/api/quiz/results/:userId', function (req, res) {//readfile default buffer
...
// // app.get('/api/quiz/results/:userId/summary', function (req, res) {//readfile default buffer
// //     readJsonFile('userQA.json', users => {
...
// // //ok
// // app.post('/api/quiz/:username/create', function (req, res) {
// //     readJsonFile('userQA.json', users => {
...
// // }
// //ok
// app.put('/api/quiz/:username/update', function (req, res) {
//     readJsonFile('userQA.json', users => {
//         console.log(req)
...
// //     "answerId": 1
// // }
// app.post('/api/quiz/:username/answer', function (req, res) {
//     readJsonFile('userQA.json', users => {
...
// //ok
// app.get('/api/quiz/:username/get-questions', function (req, res) {
//     readJsonFile('userQA.json', users => {
...
// //ok
// // app.get('/api/quiz/:username/get-question', function (req, res) {
// //     readJsonFile('userQA.json', users => {
